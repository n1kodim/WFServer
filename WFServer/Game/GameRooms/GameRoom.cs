    ...
    public partial class GameRoom : IDisposable
    {
        ...
        */
        ...
        public static GameRoom CreateRoom(Client initiator, Mission mission/*, XmlElement q*/, RoomType type/*, string group_id*/)
        {
            ...
            switch (type)
            {
                case RoomType.PvP_Public:
                    {
                        room._extensions.Add(new GameRoomCore(string.Format(ROOM_DEFAULT_NAME, initiator.Profile.Nickname), Config.GameRoom.PVP_PUBLIC_MIN_PLAYERS_READY));
                        room._extensions.Add(new GameRoomMaster(initiator));
                    }
                    break;
                case RoomType.PvE_Private:
                    {
                        room._extensions.Add(new GameRoomCore(string.Format(ROOM_DEFAULT_NAME, initiator.Profile.Nickname), Config.GameRoom.PVE_PRIVATE_MIN_PLAYERS_READY));
                        room._extensions.Add(new GameRoomMaster(initiator));
                    }
                    break;
                case RoomType.PvP_Autostart:
                    {
                        room._extensions.Add(new GameRoomCore(string.Format(QUICK_ROOM_DEFAULT_NAME, room.Id), Config.GameRoom.PVP_AUTOSTART_MIN_PLAYERS_READY));
                ...
                case RoomType.PvE_Autostart:
                    {
                        room._extensions.Add(new GameRoomCore(string.Format(ROOM_DEFAULT_NAME, initiator.Profile.Nickname), Config.GameRoom.PVE_AUTOSTART_MIN_PLAYERS_READY));
                        room._extensions.Add(new GameRoomAutoStart(room));
                        room._extensions.Add(new GameRoomSquadsColors(room));
                    }
                    break;
                case RoomType.PvP_ClanWar:
                    {
                        room._extensions.Add(new GameRoomCore(string.Format(ROOM_DEFAULT_NAME, initiator.Profile.Nickname), Config.GameRoom.PVP_CLANWAR_MIN_PLAYERS_READY));
                ...
                case RoomType.PvP_Rating:
                    {
                        room._extensions.Add(new GameRoomCore(string.Format(ROOM_DEFAULT_NAME, initiator.Profile.Nickname), Config.GameRoom.PVP_RATING_MIN_PLAYERS_READY));
                        room._extensions.Add(new GameRoomAutoStart(room));
                        room._extensions.Add(new GameRoomSquadsColors(room));
                    }
                    break;
        ...
        public void StartRatingTimer()
        {
            ...
            Utils.Delay(5).ContinueWith(task =>
            {
                if (rCore.MinReadyPlayers != rCore.Players.Count)
                {
                    foreach (var player in rCore.Players.ToList())
        ...
        public void StartMasterLoseTimer(Client master)
        {
            ...
            Utils.Delay(10).ContinueWith(task => 
            {
        ...
        public void MissionLoad()
        {
            ...
            Utils.Delay(2).ContinueWith(task => MissionLoad());
        }
