    ...
    public static class AdminCmd
    {
        ...
        public static void AdminCmdSerializer(Client client, Iq iq)
        {
            ...
            if (!string.IsNullOrEmpty(result))
            {
                ...
                Notification.SyncNotifications(client, Notification.MessageNotification($"WFServer v{string.Format("{0}.{1}.{2}", Server.Version.Major, Server.Version.Minor, Server.Version.Build)}<br>" + result));
            }
