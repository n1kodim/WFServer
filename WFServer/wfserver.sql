...
-- Dumping database structure for wfserver
CREATE DATABASE IF NOT EXISTS `wfserver` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
USE `wfserver`;

-- Dumping structure for table wfserver.emu_abuse_reports
...
-- Dumping data for table wfserver.emu_abuse_reports: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_achievements
...
-- Dumping data for table wfserver.emu_achievements: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_anticheat_punish_mode
CREATE TABLE IF NOT EXISTS `emu_anticheat_punish_mode` (
  `profile_id` bigint(20) unsigned NOT NULL,
  `punish_mode` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table wfserver.emu_anticheat_punish_mode: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_anticheat_report
...
-- Dumping data for table wfserver.emu_anticheat_report: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_banforleave
...
-- Dumping data for table wfserver.emu_banforleave: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_bans
...
-- Dumping data for table wfserver.emu_bans: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_clans
...
-- Dumping data for table wfserver.emu_clans: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_clan_members
...
-- Dumping data for table wfserver.emu_clan_members: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_connects
...
-- Dumping data for table wfserver.emu_connects: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_dynamic_multipliers
...
-- Dumping data for table wfserver.emu_dynamic_multipliers: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_friends
CREATE TABLE IF NOT EXISTS `emu_friends` (
  `first_id` bigint(20) unsigned NOT NULL,
  `second_id` bigint(20) unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- Dumping data for table wfserver.emu_friends: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_items
...
-- Dumping data for table wfserver.emu_items: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_login_bonus
...
-- Dumping data for table wfserver.emu_login_bonus: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_mutes
...
-- Dumping data for table wfserver.emu_mutes: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_notifications
...
-- Dumping data for table wfserver.emu_notifications: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_pc_info
...
-- Dumping data for table wfserver.emu_pc_info: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_persistent_settings
...
-- Dumping data for table wfserver.emu_persistent_settings: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_pin_codes
...
-- Dumping data for table wfserver.emu_pin_codes: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_pin_used
...
-- Dumping data for table wfserver.emu_pin_used: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_profiles
CREATE TABLE IF NOT EXISTS `emu_profiles` (
  ...
  `game_money` int(11) NOT NULL DEFAULT 9999999,
  `cry_money` int(11) NOT NULL DEFAULT 9999999,
  `crown_money` int(11) NOT NULL DEFAULT 9999999,
...
-- Dumping data for table wfserver.emu_profiles: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_profile_bans
...
-- Dumping data for table wfserver.emu_profile_bans: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_profile_progression_state
...
-- Dumping data for table wfserver.emu_profile_progression_state: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_pvp_rating
...
-- Dumping data for table wfserver.emu_pvp_rating: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_sponsors
...
-- Dumping data for table wfserver.emu_sponsors: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_stats
...
-- Dumping data for table wfserver.emu_stats: ~0 rows (approximately)

-- Dumping structure for table wfserver.emu_users
...
-- Dumping data for table wfserver.emu_users: ~2 rows (approximately)
